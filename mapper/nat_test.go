		...
		Convey("When i try to map nats", func() {
			Convey("And the input specifies bootstrap as salt", func() {
				...
				Convey("Then it should map salt and input firewall rules", func() {
					...
					So(n[0].Rules[0].OriginIP, ShouldEqual, "$(routers.items.0.ip)")
					...
					So(n[0].Rules[1].OriginIP, ShouldEqual, "$(routers.items.0.ip)")
					...
					So(n[0].Rules[2].TranslationIP, ShouldEqual, "$(routers.items.0.ip)")
					...
					So(n[0].Rules[3].TranslationIP, ShouldEqual, "$(routers.items.0.ip)")
			...
			Convey("And the input specifies bootstrap as not salt", func() {
				...
				Convey("Then it should map only the input firewall rules", func() {
					...
					So(n[0].Rules[0].TranslationIP, ShouldEqual, "$(routers.items.0.ip)")
